...
internal class ApplicationIo
{
    ...
    public void Out(string msg, params object?[]? args) => _stdout.Write(msg, args ?? []);

    public void ErrLine(string msg, params object?[]? args) => ErrWriter.WriteLine(msg, args ?? []);
}
